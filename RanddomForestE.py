...
def createDataFrame(randomForestModel):
    lr_results = pd.DataFrame({'RanddomForest with e_Mbh': [randomForestModel.get_train_mse(), randomForestModel.get_train_r2(), randomForestModel.get_test_mse(), randomForestModel.get_test_r2()]})
